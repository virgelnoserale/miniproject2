...
const buttonElem = document.querySelector('#review button');

//const nameArray = JSON.parse(localStorage.getItem('input-full-name')) || [];
const reviewArray = JSON.parse(localStorage.getItem('review3')) || [];
...
function updateList(){
  ...
  localStorage.setItem('review3',JSON.stringify(reviewArray));
}
